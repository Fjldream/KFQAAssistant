...
describe("EvidencePanel", () => {
  ...
  it("opens a manual-style material dialog when a source is clicked", async () => {
    const source: SourceSnippet = {
      title: "工程开发-Windows",
      source_path: "html/数采管理/工程开发-Windows/index.html",
    ...
    expect(wrapper.text()).toContain("资料中心");
    expect(wrapper.find(".ki-material-dialog").exists()).toBe(true);
